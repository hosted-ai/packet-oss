...
CREATE TABLE "new_ProviderNode" (
    ...
    "hostedaiPoolId" TEXT,
    "hostedaiNodeId" TEXT,
    "gpuaasNodeId" INTEGER,
    "gpuaasRegionId" INTEGER,
    "gpuaasClusterId" INTEGER,
    "gpuaasPoolId" INTEGER,
    "gpuaasInitStatus" TEXT,
    "gpuaasSshKeysInstalled" BOOLEAN NOT NULL DEFAULT false,
    "externalServiceIp" TEXT,
